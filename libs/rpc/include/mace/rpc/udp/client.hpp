...
namespace mace { namespace rpc { namespace udp {
   ...
   */
  template<typename InterfaceType, typename ConnectionType = mace::rpc::raw::udp::connection<raw_io> >
...
#endif // _MACE_RPC_UDP_CLIENT_HPP_
